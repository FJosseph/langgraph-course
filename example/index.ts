...
const handler = async () => {
  ...
  const systemPrompt = new SystemMessage(
    `Eres un agente inteligente que ayuda a los desarrolladores a utilizar la librería de Smile UI.
  ...
  const userPrompt = new HumanMessage("Explícame sobre el componente SForm");
